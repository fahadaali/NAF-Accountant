...
--
-- ⚠️ غير مستعمل حتى الآن: لا استعلام واحد عليه في الكود. أُبقي لأن الترحيل
-- المطبَّق لا يُعدَّل بأثر رجعي — لكن لا تبنِ عليه قبل أن يُستعمل فعلاً.
-- الإعدادات اليوم كلها في متغيّرات Cloudflare.
-- ----------------------------------------------------------------------------
