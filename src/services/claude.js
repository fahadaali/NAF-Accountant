...
//   - manual_journal : قيد محاسبي يدوي (رواتب، تحويلات صادرة عامة).
//   - purchase_bill  : فاتورة مشتريات (سداد / مشتريات).
//   - sales_invoice  : فاتورة مبيعات (وارد: دفعات / اشتراكات) + ضريبة 15%.
//
...
3. "sales_invoice" — أي مبلغ وارد كسداد دفعات أو اشتراكات من عميل (فاتورة مبيعات)، وتُضاف عليه ضريبة قيمة مضافة ${vatPercent}%، ويجب تحديد اسم العميل.
...
- إن طُلب "بدون ضريبة" لفاتورة مبيعات، اجعل vat_percent = 0.
