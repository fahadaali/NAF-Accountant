...
│       ├── format.js             # العزل الاتجاهي وصيغ الأرقام والتواريخ
│       ├── report_render.js      # بناء التقرير المالي HTML (بلا ذكاء اصطناعي)
...
والتقرير المالي (`0 7 1 * *`) يُشغَّل يدوياً بـ
`GET /api/reports/financial?period=monthly|quarterly|annual`.

**التقرير المالي لا يمرّ بالذكاء الاصطناعي.** متنه يُبنى حتمياً من بيانات
وافق في `src/lib/report_render.js`: كل رقم يظهر كما ورد، ولا مجموع يُحتسب
محلياً. كان يُبنى بتمرير البيانات إلى Claude، فتوقّف إصداره يوم نفد رصيد
حساب Anthropic — ارتباطٌ بلا مقابل، إذ لا ذكاء في تحويل جدول إلى جدول.

والقسمان (الأرباح والخسائر، ميزان المراجعة) يُجلبان مستقلَّين: تعثّر أحدهما
يُنشر التقرير بالآخر ويُذكر سبب النقص في متنه وفي تنبيه المسؤولين.
